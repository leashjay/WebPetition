<template>
  <div>
    <ShareNetwork
      ...
      :quote="quote"
    >
        <span class="icon is-2by1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28"><path
    ...
    <ShareNetwork
      ...
      :quote="quote"
    >
      <span class="icon is-2by1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29 29"><path
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: "https://canterbury.ac.nz",
        title: "Here is a petition that interests me",
        description: "I signed it, so should you!",
        quote: "Real change, enduring change, happens one step at a time - the Notorious Ruth Bader Ginsburg"
      }
    }
  }
